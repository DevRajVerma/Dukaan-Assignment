...
export default function Overlap() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 pb-6">
      {/* Blue Header */}
      <div className="bg-blue-700 h-48 text-white relative flex justify-between p-6">
        <div >
          <Icon />
        </div>
        <div>
          <h3 className="hover:underline">Sign in</h3>
          <button className=" text-blue-700 font-xl font-bold   px-6 py-2 rounded bg-white">
            Generate slogans
          </button>
        </div>
      </div>
